...
tags: [nx, deps-tree, git-grep, path-alias, project-filter, dedup-detection, circular-detection]
...
tech-stack:
  added: []
  patterns: [dedup-tracking-via-set, reverse-adjacency-build, git-grep-scoping, fixed-vs-regex-mode, arrow-output-format]
