...
> Source: [https://www.dandoescode.com/blog/parallel-vibe-coding-with-git-worktrees](https://www.dandoescode.com/blog/parallel-vibe-coding-with-git-worktrees)
...
![Bad example, parallelizing work via multiple clones](https://www.dandoescode.com/static/images/parallel-vibe-coding-with-git-worktrees/cloning.png)
...
A git worktree is an additional working directory attached to the same repository. Each worktree has its own checkout of a branch and its own independent set of files on disk — but they all share the same _git history, objects, and config_.
...
![Two VS Code windows open, each on a different git worktree branch](https://www.dandoescode.com/static/images/parallel-vibe-coding-with-git-worktrees/vscode.png)
