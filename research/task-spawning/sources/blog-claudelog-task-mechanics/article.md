...
> Source: [https://claudelog.com/mechanics/task-agent-tools/](https://claudelog.com/mechanics/task-agent-tools/)
> Author: Author:InventorBlack|CTO at Command Stick|Mod at r/ClaudeAi
> Site: ClaudeLog

---
The Task tool is Claude Code's secret weapon for speed. It delegates work to parallel sub-agents—file reads, code searches, web fetches—running up to 7 agents simultaneously. Master this tool and watch your workflow accelerate dramatically.
